...
module.exports = ctx => {
  ...
  Post.virtual('asset_dir').get(function() {
    ...
    console.log(src.substring(0, src.length - pathFn.extname(src).length) + ".assets"+ pathFn.sep);
    return src.substring(0, src.length - pathFn.extname(src).length) + ".assets" + pathFn.sep;
  });
